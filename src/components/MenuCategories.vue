<template>
	<div class="wrapper">
		...
		<section class="menu__categories">
			<div class="menu__category" @click="goToCategory('rolls')">
				<h3>Роли</h3>
				<div class="menu__category-img">
					<img src="@/assets/images/categories/menu-1.jpg">
				</div>
			</div>
			<div class="menu__category" @click="goToCategory('sets')">
				<h3>Набори і сети</h3>
				<div class="menu__category-img">
					<img src="@/assets/images/categories/menu-2.jpg">
				</div>
			</div>
			<div class="menu__category" @click="goToCategory('salads')">
				<h3>Салати</h3>
				<div class="menu__category-img">
					<img src="@/assets/images/categories/menu-3.jpg">
				</div>
			</div>
			<div class="menu__category" @click="goToCategory('hots')">
				<h3>Гарячі страви</h3>
				<div class="menu__category-img">
					<img src="@/assets/images/categories/menu-4.jpg">
				</div>
			</div>
			<div class="menu__category" @click="goToCategory('pizza')">
				<h3>Піца</h3>
				<div class="menu__category-img">
					<img src="@/assets/images/categories/menu-5.jpg">
				</div>
			</div>
			<div class="menu__category" @click="goToCategory('drinks')">
				<h3>Напої</h3>
				<div class="menu__category-img">
